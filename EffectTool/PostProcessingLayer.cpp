...
bool CPostProcessingLayer::Begin() {
	...
	m_pCSDownScaleFirstPass = new CDownScaleFirstPassShader();
	m_pCSDownScaleFirstPass->Begin();
	m_pCSDownScaleSecondPass = new CDownScaleSecondPassShader();
	m_pCSDownScaleSecondPass->Begin();

	//bloom
	m_pCSBloom = new CCSBloom();
	m_pCSBloom->Begin();

	//blur
	m_pCSHorizontalBlur = new CCSHorizontalBlur();
	m_pCSHorizontalBlur->Begin();
	m_pCSVerticalBlur = new CCSVerticalBlur();
